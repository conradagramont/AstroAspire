...
export async function fetchData<Selected extends Endpoint>(endpoint: Selected) {
	...
	console.log('lib/data.ts fetchData() apiEndpoint: ', apiEndpoint);
...
export function url(path = '') {
	...
	// console.log('lib/data.ts url() process.env.SITE: ', process.env.SITE);
	// console.log('lib/data.ts url() process.env.BASE_URL: ', process.env.BASE_URL);
	//console.log('lib/data.ts url() process.env: ', process.env);
	//return `${process.env.SITE}${process.env.BASE_URL}${path}`;
}
